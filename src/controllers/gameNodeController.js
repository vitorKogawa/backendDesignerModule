...
class GameNodeController {
  ...
  findByID = async (request, response) => {
    try {
      const gameNode = await GameNode.findById(request.params.id).populate(
        'labels'
      );
  ...
  editNextNodesByID = async (request, response) => {
    ...
    try {
      ...
      return response.status(400).send({ error: 'Failed to update node.' });
    }
  };
  ...
  editLabelsByID = async (request, response) => {
    ...
    try {
      ...
      return response.status(400).send({ error: 'Failed to update labels.' });
    }
  };
  ...
  editByID = async (request, response) => {
    const {
 name, duration, markdownContent, theme, compiled_content 
} =      request.body;
    try {
      const gameNode = await GameNode.findById(request.params.id);
  ...
  deleteByID = async (request, response) => {
    ...
    try {
      ...
      return response.status(200).send({ success: 'Node has been deleted.' });
    } catch (err) {
      return response
        .status(400)
