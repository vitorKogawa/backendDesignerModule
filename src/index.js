...
const publisher = redis.createClient({port: 19196, password: 'Hjc*H^kDzZuxV6@HiZYY#m6KefVCkz&kb%h5gtpT', host:'redis-19196.c273.us-east-1-2.ec2.cloud.redislabs.com'});
const subscriber = redis.createClient({port: 19196, password: 'Hjc*H^kDzZuxV6@HiZYY#m6KefVCkz&kb%h5gtpT', host:'redis-19196.c273.us-east-1-2.ec2.cloud.redislabs.com'});
